<footer class="bg-indigo-700 text-gray-100">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-300">
                    We are dedicated to providing high-quality education and resources to help you achieve your goals.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="text-sm text-gray-200">Office #13, NSTP, NUST University, Islamabad</li>
                    <li class="text-sm text-gray-200">Email: contact@portfolio.com</li>
                    <li class="text-sm text-gray-200">Phone: +92 123 4567890</li>
                </ul>
            </div>
        </div>
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <!-- Copyright -->
            <p class="text-sm text-gray-200 mt-4 md:mt-0">© 2025 Teacher Portfolio. All rights reserved.</p>
        </div>
    </div>
</footer>
